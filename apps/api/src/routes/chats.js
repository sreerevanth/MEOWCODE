...
async function completeChat(request, reply) {
    ...
    let connectionConfig = { providerId: targetModel.providerId };
    ...
    if (dbConn) {
        connectionConfig = {
            ...
            headers: dbConn.customHeaders ?? undefined,
            timeoutMs: dbConn.timeoutMs,
            retryPolicy: dbConn.retryPolicy ?? undefined
        };
    }
