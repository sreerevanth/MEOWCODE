...
async function printProviders(client, workspaceId) {
    try {
...
async function printModels(client, workspaceId) {
    try {
...
async function printHistory(client, workspaceId) {
    try {
...
async function streamPrompt(client, text, workspaceId) {
